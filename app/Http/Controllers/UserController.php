...
class UserController extends Controller
{
    public function index()
    {
        ...
        $salaire_sauve = User::where('id', auth()->user()->id)->first()->salaire_sauve;
        ...
        return view('user.dashboard', compact('Montant_restant', 'mon_salaire', 'total_depense_alimentation', 'objectif_mensuel', 'salaire_sauve'));
    }
